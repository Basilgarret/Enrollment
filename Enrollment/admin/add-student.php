...
<div class="col-sm-6">
	...
	<form enctype="multipart/form-data" method="POST" action="">
		<div class="form-group">
		  ...
		  <div class="form-group">
		    <label for="class">Student Strand</label>
		    <select name="class" class="form-control" id="class" >
		    	<option>Select</option>
		    	<option value="1st">Stem</option>
		    	<option value="2nd">Humss</option>
		    	<option value="3rd">Abm</option>
		    	<option value="4th">Tvl</option>
		    	<option value="5th">Arts</option>
		    </select>
	  	</div>
	  	<div class="form-group">
